...
export default function LocationSection() {
  return (
    <section
      className="w-full px-4 sm:px-8 lg:px-12 xl:px-16 py-16 sm:py-24 max-w-[1400px] mx-auto"
      id="map"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-navy font-bold mb-6">
            Chỉ Đường Đến Buổi Lễ
          </h2>
          <p className="text-lg sm:text-xl text-navy/70 mb-10 leading-relaxed">
            Buổi lễ sẽ được tổ chức tại Hội trường Khu D của Đại học Nam Cần
            Thơ. Vui lòng gửi xe tại Bãi đậu xe và di chuyển theo bảng chỉ dẫn.
          </p>
          ...
          <div className="glass-card p-8 space-y-8 rounded-2xl border border-gold/25 shadow-lg">
            <div className="flex items-start gap-5">
              ...
              <div>
                <p className="font-serif font-bold text-navy text-lg sm:text-xl mb-1">
                  Bãi đậu xe (Parking)
                </p>
                <p className="text-navy/70 text-base sm:text-lg">
                  Vui lòng gửi xe tại khu vực được đánh dấu trên bản đồ .
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-navy/70 text-base sm:text-lg">
                  Địa điểm chính của buổi lễ, nằm tại trung tâm khuôn viên Khu
                  D.
                </p>
              </div>
            </div>
