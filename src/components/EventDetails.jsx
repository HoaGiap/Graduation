  ...
  const cardsData = [
    {
      ...
      tags: ["Thứ Bảy", "22/08/2026", "Chính Thức", "Tốt Nghiệp"],
      title: "22 / 08 / 2026",
    ...
    },
    {
      ...
      tags: ["8:00 AM", "Kính Mời", "Thời Lượng ~2H", "Time"],
      title: "8:00 AM",
      body: "Buổi lễ chính thức bắt đầu lúc 8:00AM, kính mời bạn đến dự lễ tốt nghiệp của mình.",
    },
    {
      id: "location",
      ...
      body: "Buổi lễ diễn ra tại trung tâm khuôn viên. Gửi xe tại nhà gửi xe và di chuyển theo biển hướng dẫn.",
      hasMapAction: true,
    },
  ];
